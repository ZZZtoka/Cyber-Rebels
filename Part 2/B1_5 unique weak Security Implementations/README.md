## B1_5 unique weak Security Implementations

## Description
I explored weak security implementations commonly found in everyday environments that may expose systems and data to potential cyber threats.

## Findings
- Weak passwords that are easy to guess
- Websites without HTTPS encryption
- Public WiFi networks without authentication
- Devices without proper access control
...
## Reflection
This activity made me realise that many security vulnerabilities exist in everyday environments due to simple misconfigurations or user negligence. I previously underestimated risks such as public WiFi and weak passwords, but now understand how easily attackers can exploit them. Strengthening basic security practices is essential to reduce exposure to common threats.